...
connection= 
DriverManager.getConnection("jdbc:ucanaccess://C:\\Users\\admin.BIOINFO\\Desktop\\
StudentDatabase.accdb");//Establishing Connection
System.out.println("Connected Successfully");
//Creating PreparedStatement object
PreparedStatement preparedStatement=connection.prepareStatement("insert into 
Student(SName,RegNo,email,Mobile,Branch) values(?,?,?,?,?)");
...
set SName=?, email=?,Mobile=?,Branch=? where RegNo=?");
preparedStatement.setString(1,nameField.getText());
